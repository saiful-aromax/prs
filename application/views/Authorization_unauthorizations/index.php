...
<?php echo form_open("authorization_unauthorizations/ajax_report"); ?>
    ...
    <div class="box-body col-sm-offset-2">
        ...
        <div class="form-group" style="margin-bottom: 15px;">
            <div class="sidebar-toggle input-group col-sm-offset-4 col-sm-4">
                <input value="Generate" onclick="ajax_report()"
                       class="btn btn-success pull-right submit_buttons positive btn_generate" type="button"
                       data-toggle="offcanvas"
                       id="checkbox1">
                <!--                <input value="Authorize" onclick="ajax_submit_authorization_form()"-->
                <!--                       class="btn btn-success pull-right submit_buttons positive" type="button" data-toggle="offcanvas"-->
                <!--                       id="checkbox1">-->
            </div>
        </div>
    </div>
    <input type="hidden" name="is_authorization" id="is_authorization" value="<?php echo $is_authorization; ?>">
    <div id="form_html">
...
<script type="text/javascript">
    ...
    function ajax_report() {
        ...
        var is_authorization = $("#is_authorization").val();

        if (validate(id_projects, id_reporting_periods, id_years, type)) {
            $.ajax({
                url: "<?php echo base_url('authorization_unauthorizations/ajax_report'); ?>",
                type: "post",
                data: {
    ...
    function ajax_submit_authorization_form() {
