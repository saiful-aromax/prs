<?php echo form_open("disaggregate_tiers/" . $action); ?>
    ...
    <div class="box-body col-sm-offset-2">
        ...
        <div class="form-group" style="margin-bottom: 15px;">
            <div class="input-group col-sm-offset-4 col-sm-4">
                ...
                <?php echo form_button(['name' => 'button', 'id' => 'button', 'value' => 'true', 'type' => 'reset', 'content' => 'Cancel', 'class' => 'btn btn-danger pull-right cancel_buttons', 'onclick' => "window.location.href='" . site_url('disaggregate_tiers') . "'"]); ?>
            </div>
        </div>
        <?php echo form_close(); ?>
    </div>
