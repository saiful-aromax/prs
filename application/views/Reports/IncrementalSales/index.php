<div class="box box-info">
    <div class="box-body col-sm-offset-2">
        <?php echo form_open("reports/ajax_generate_IncrementalSales_report"); ?>

        <input id="indicator_id" type="hidden" name="indicator_id" value="12">
...
<!--        <a download="somedata.csv" href="#" onclick="return ExcellentExport.csv(this, 'datatable');">Export to CSV</a>-->
        ...
        <div class="form-group" style="margin-bottom: 15px;">
            <div class="sidebar-toggle input-group col-sm-offset-4 col-sm-4">
                <input value="Generate" onclick="ajax_generate_IncrementalSales_report()"
...
<script type="text/javascript">
    ...
    function ajax_generate_IncrementalSales_report(report_type = '') {
        var indicator_id = $("#indicator_id").val();
        var id_reporting_periods = $("#id_reporting_periods").val();
        var type = '<?php echo $type; ?>';
        var id_years = $("#id_years").val();
        if (validate(id_reporting_periods, id_years)) {
            $.ajax({
                url: "<?php echo base_url('reports/ajax_generate_IncrementalSales_report'); ?>",
                type: "post",
                data: {
    ...
    function validate(id_reporting_periods, id_years) {
        var status = true;
        var error_message = "";
