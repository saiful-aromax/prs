...
//                $i++;
            ...
            <tr>
                ...
                <?php if ($show_target == '1' && $type == 'Result') {
                    if (isset($id_periods[1]) || $id_reporting_periods == 1) { ?>
                        <td class="<?php echo $odd_even_class; ?>">
                            <input type="text"
                                   name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                                   value="<?php echo $row['transaction']['Target_annual']; ?>"
                                   class="input_textbox form-control form_field"
                                   maxlength="100" <?php echo ($id_reporting_periods == 1) ? 'disabled' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                        </td>
                    <?php } ?>
                    <?php if (isset($id_periods[2]) || $id_reporting_periods == 2) { ?>
                        <td class="<?php echo $odd_even_class; ?>">
                            <input type="text"
                                   name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                                   value="<?php echo $row['transaction']['Target_semi_annual_1']; ?>"
                                   class="input_textbox form-control"
                                   maxlength="100" <?php echo ($id_reporting_periods == 2) ? 'disabled' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                        </td>
                    ...
                    <?php if (isset($id_periods[3]) || $id_reporting_periods == 3) { ?>
                        <td class="<?php echo $odd_even_class; ?>">
                            <input type="text"
                                   name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                                   value="<?php echo $row['transaction']['Target_semi_annual_2']; ?>"
                                   class="input_textbox form-control"
                                   maxlength="100" <?php echo ($id_reporting_periods == 3) ? 'disabled' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                        </td>
                    <?php } ?>
                    <?php if (isset($id_periods[4]) || $id_reporting_periods == 4) { ?>
                        <td class="<?php echo $odd_even_class; ?>">
                            <input type="text"
                                   name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                                   value="<?php echo $row['transaction']['Target_q1']; ?>"
                                   class="input_textbox form-control"
                                   maxlength="100" <?php echo ($id_reporting_periods == 4) ? 'disabled' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                        </td>
                    <?php } ?>
                    <?php if (isset($id_periods[5]) || $id_reporting_periods == 5) { ?>
                        <td class="<?php echo $odd_even_class; ?>">
                            <input type="text"
                                   name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                                   value="<?php echo $row['transaction']['Target_q2']; ?>"
                                   class="input_textbox form-control"
                                   maxlength="100" <?php echo ($id_reporting_periods == 5) ? 'disabled' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                        </td>
                    <?php } ?>
                    <?php if (isset($id_periods[6]) || $id_reporting_periods == 6) { ?>
                        <td class="<?php echo $odd_even_class; ?>">
                            <input type="text"
                                   name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                                   value="<?php echo $row['transaction']['Target_q3']; ?>"
                                   class="input_textbox form-control"
                                   maxlength="100" <?php echo ($id_reporting_periods == 6) ? 'disabled' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                        </td>
                    <?php } ?>
                    <?php if (isset($id_periods[7]) || $id_reporting_periods == 7) { ?>
                        <td class="<?php echo $odd_even_class; ?>">
                            <input type="text"
                                   name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                                   value="<?php echo $row['transaction']['Target_q4']; ?>"
                                   class="input_textbox form-control "
                                   maxlength="100" <?php echo ($id_reporting_periods == 7) ? 'disabled' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                        </td>
                    <?php }
                } ?>
                <?php if (isset($id_periods[1]) || $id_reporting_periods == 1) { ?>
                    <td class="<?php echo $odd_even_class; ?>">
                        <input type="text"
                               name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                               value="<?php echo $row['transaction'][$type . '_annual']; ?>"
                               class="input_textbox form-control form_field <?php echo ($id_reporting_periods == 1) ? ('data_entry ' . $disaggregate_group_class) : ''; ?>"
                               maxlength="100" <?php echo ($id_reporting_periods == 1) ? '' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                    </td>
                <?php } ?>
                <?php if (isset($id_periods[2]) || $id_reporting_periods == 2) { ?>
                    <td class="<?php echo $odd_even_class; ?>">
                        <input type="text"
                               name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                               value="<?php echo $row['transaction'][$type . '_semi_annual_1']; ?>"
                               class="input_textbox form-control <?php echo ($id_reporting_periods == 2) ? ('data_entry ' . $disaggregate_group_class) : ''; ?>"
                               maxlength="100" <?php echo ($id_reporting_periods == 2) ? '' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                    </td>
                <?php } ?>
                <?php if (isset($id_periods[3]) || $id_reporting_periods == 3) { ?>
                    <td class="<?php echo $odd_even_class; ?>">
                        <input type="text"
                               name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                               value="<?php echo $row['transaction'][$type . '_semi_annual_2']; ?>"
                               class="input_textbox form-control <?php echo ($id_reporting_periods == 3) ? ('data_entry ' . $disaggregate_group_class) : ''; ?>"
                               maxlength="100" <?php echo ($id_reporting_periods == 3) ? '' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                    </td>
                <?php } ?>
                <?php if (isset($id_periods[4]) || $id_reporting_periods == 4) { ?>
                    <td class="<?php echo $odd_even_class; ?>">
                        <input type="text"
                               name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                               value="<?php echo $row['transaction'][$type . '_q1']; ?>"
                               class="input_textbox form-control <?php echo ($id_reporting_periods == 4) ? ('data_entry ' . $disaggregate_group_class) : ''; ?>"
                               maxlength="100" <?php echo ($id_reporting_periods == 4) ? '' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                    </td>
                <?php } ?>
                <?php if (isset($id_periods[5]) || $id_reporting_periods == 5) { ?>
                    <td class="<?php echo $odd_even_class; ?>">
                        <input type="text"
                               name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                               value="<?php echo $row['transaction'][$type . '_q2']; ?>"
                               class="input_textbox form-control <?php echo ($id_reporting_periods == 5) ? ('data_entry ' . $disaggregate_group_class) : ''; ?>"
                               maxlength="100" <?php echo ($id_reporting_periods == 5) ? '' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                    </td>
                <?php } ?>
                <?php if (isset($id_periods[6]) || $id_reporting_periods == 6) { ?>
                    <td class="<?php echo $odd_even_class; ?>">
                        <input type="text"
                               name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                               value="<?php echo $row['transaction'][$type . '_q3']; ?>"
                               class="input_textbox form-control <?php echo ($id_reporting_periods == 6) ? ('data_entry ' . $disaggregate_group_class) : ''; ?>"
                               maxlength="100" <?php echo ($id_reporting_periods == 6) ? '' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                    </td>
                <?php } ?>
                <?php if (isset($id_periods[7]) || $id_reporting_periods == 7) { ?>
                    <td class="<?php echo $odd_even_class; ?>">
                        <input type="text"
                               name="value[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"
                               value="<?php echo $row['transaction'][$type . '_q4']; ?>"
                               class="input_textbox form-control <?php echo ($id_reporting_periods == 7) ? ('data_entry ' . $disaggregate_group_class) : ''; ?>"
                               maxlength="100" <?php echo ($id_reporting_periods == 7) ? '' : 'disabled' ?> <?php if ($row['disaggregate_name'] == 'Sub-total') { ?> disabled="disabled" <?php } ?>>
                    </td>
                <?php } ?>
                <?php if ($type == 'Result') {
                    $deviation = 0;
                    ...
                    if ($disaggregate_group_id != $row['disaggregate_group_id']) { ?>
                        <input type="hidden" name="deviations[<?php echo $deviation_class; ?>]"
                               value="<?php echo $deviation; ?>"
                    ...
                    if ($indicator_id != $row['indicator_id']) {
                        ...
                        <td rowspan="<?php echo $row['indicator_rowspan']; ?>"
                            ...
                            <textarea style="height: <?php echo ((int)$row['indicator_rowspan']) * 40; ?>px"
                                      rows="<?php echo $row['indicator_rowspan']; ?>"
                                      name="deviation_narratives[<?php echo $row['indicator_id']; ?>]"
                                      class=""></textarea>
                        </td>
                    <?php }
                }
                if ($type == 'Result' || $type == 'Target') {
                    ...
                    <?php } ?>
                <?php } ?>
                <?php if ($row['disaggregate_name'] != 'Sub-total') {
                    ?>
                    <td>
                        <textarea
                                name="remarks[<?php echo $row['id_project_indicator_disaggregate_sets']; ?>]"><?php echo $row['remarks'][$type][$id_years][$id_reporting_periods]; ?></textarea>
                    </td>
                <?php } else { ?>
                    <td>&nbsp;</td>
                <?php } ?>
...
<div class="form-group">
    <div class="input-group col-sm-offset-4 col-sm-4">
        <button style="margin-bottom: 15px;" type="submit" onclick="return on_submit_validation();"
                class="btn btn-success pull-right submit_buttons positive" type="submit">Process
        </button>
    </div>
</div>
<?php echo form_close(); ?>
