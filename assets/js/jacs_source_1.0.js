/* *****************************************************************************
     JavaScript Advanced Calendar Scrpt (JACS) - Cross-Browser pop-up calendar.
...
//******************************************************************************
     ...
     document.writeln(
        '<style type="text/css">' +
            '.jacs, .jacsStatic {padding:0px;vertical-align:middle;}' +
            'iframe.jacs        {position:absolute;visibility:hidden;' +
                                'top:0px;left:0px;width:1px;height:1px;}' +
            'table.jacs, ' +
            'table.jacsStatic   {padding:0px;visibility:hidden;' +
    ...
    // This style sheet can be extracted from the script and edited into regular
     ...
     document.writeln(
        '<style type="text/css">' +
            ...
            'select.jacsHead             {margin:        0px 0px;}' +
            'input.jacsHead              {height:        auto;' +
                                         'width:         auto;' +
                                         'vertical-align:middle;' +
                                         'text-align:    center;' +
                                         'margin:        0px 0px;' +
            ...
            '/* Calendar background */' +
            'table.jacs,' +
            'table.jacsStatic            {background-color: #EEEEEE;}' +
            '/* Drag Handle */' +
            ...
            '/* Highlighted Days */' +
            '/* Week Day */' +
            'td.jacsCellsHighlighted     {background-color:  #FFF0A5;border: solid 1px #FED22F;' +
                                         'color:             #111;}' +
            '/* Weekend Day */' +
            ...
            '/* Day matching the input date */' +
            'td.jacsInputDate:hover,' +
            'td.jacsInputDateHover       {background-color:  #FFF0A5;' +
                                         'cursor:            pointer;' +
                                         'color:             #000000;}' +
            '/* Weekend cells */' +
            'td.jacsCellsWeekend:hover,' +
            'td.jacsCellsWeekendHover    {background-color:  #FFF0A5;' +
                                         'cursor:            pointer;' +
                                         'color:             #000000;}' +
            '/* Day outside the current month */' +
            'td.jacsCellsExMonth:hover,' +
            'td.jacsCellsExMonthHover    {background-color:  #FFF4BB;' +
                                         'cursor:            pointer;' +
                                         'color:             #000000;}' +
            '/* Clear Button */'                                        +
        ...
        {switch (cal.id)
            {case 'EnterYourIDHere':
             ...
             default:
                ...
                cal.formatTodayCell = true;
                cal.todayCellBorderColour = '#CB2727'; // red
                                     ...
                                     (cal.formatTodayCell && showDate.toDateString()==dateNow.toDateString())
                                        ...
                                        :(cell.currentStyle)
                                            ...
                                            :(document.defaultView.getComputedStyle)
                                                ?document.defaultView.getComputedStyle(cell,null).backgroundColor
                                                :'';
                                 cell.style.BackgroundColor = '#FFF0A5';
                               }
